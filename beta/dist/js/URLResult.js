...
var URLResult = (function () {
  function URLResult() {
    _classCallCheck(this, URLResult);
  ...
  _createClass(URLResult, [{
    key: '_getMarketingScore',
    value: function _getMarketingScore(data) {
      var class1_perc = 50;
      var class2_perc = 30;
      var class3_perc = 20;
    ...
    key: '_updateCount',
    value: function _updateCount(data) {
    ...
    key: '_updateBulkCount',
    value: function _updateBulkCount(data) {

      var context = this;
      if (this.bulkSection.hasChildNodes()) this.bulkSection.removeChild(this.bulkSection.firstChild);
    ...
    key: '_createBulkChildHeaderElement',
    value: function _createBulkChildHeaderElement(element) {
    ...
    key: '_createBulkChildElement',
    value: function _createBulkChildElement(url, count, color, svg, tooltip) {
